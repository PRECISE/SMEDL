...
%TODO Show a basic example going over the most common features. Then have sections on other features (like elses). Finish with a full reference (maybe in a separate chapter). Actually probably do this in sections.

% Maybe have two examples: A very simple, a more complex (e.g. multiple scenarios, elses) and use that to go over the more advanced features. Then full reference.
