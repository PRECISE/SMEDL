...
int main(int argc, char const *const *argv)
{
  ...
  if (argc < 5) {
    fprintf(stderr, "Usage: node host port username password bindingkey\n");
    return 1;
  }
  ...
  amqp_queue_bind(conn, 1, queuename, amqp_cstring_bytes("smedl.topic"), amqp_cstring_bytes(bindingkey),
                  amqp_empty_table);
