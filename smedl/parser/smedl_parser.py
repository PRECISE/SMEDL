...
__version__ = (2018, 2, 1, 16, 8, 15, 3)
...
class smedlParser(Parser):
    ...
    def _object_(self):
        ...
        self.ast.setlist('imports', self.last_node)
        self._token('object')
        self._identifier_()
    ...
    def _identifier_assign_(self):
        ...
        with self._optional():
            self._token('=')
            self._literal_()
            self.ast['default'] = self.last_node
    ...
    def _import_definition_(self):
        self._token('#import')
        self._identifier_()
        self.ast['import_id'] = self.last_node
    ...
    @graken()
    def _final_state_definition_(self):
        self._token('finalstates:')
        self._identifier_()
        self.ast['final_state'] = self.last_node
    ...
    def _scenario_definition_(self):
        ...
        self._token(':')
        with self._optional():
            self._final_state_definition_()
            self.ast['final_definition'] = self.last_node
        ...
        self.ast._define(
            ['atomic', 'scenario_id', 'final_definition', 'traces'],
            []
        )
...
class smedlSemantics(object):
    ...
    def final_state_definition(self, ast):
        return ast
