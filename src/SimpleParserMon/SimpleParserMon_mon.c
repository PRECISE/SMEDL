...
typedef enum { SIMPLEPARSERMON_POINT_COUNTS, SIMPLEPARSERMON_GETDISTANCE, SIMPLEPARSERMON_GETSPEED } simpleparsermon_scenario;
...
typedef enum { SIMPLEPARSERMON_GETSPEED_EVENT, SIMPLEPARSERMON_GETLAT_EVENT, SIMPLEPARSERMON_GETTIME_EVENT, SIMPLEPARSERMON_GETDIST_EVENT, SIMPLEPARSERMON_GETLON_EVENT } simpleparsermon_event;
