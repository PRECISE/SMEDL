...
int *get_coordinates(_Explorer *monitor) {
...
void set_view(_Explorer *monitor, const void *map) {
...
int contains_object(_Explorer *monitor) {
    for(int i = 0; i < 3; i++) {
        for(int j = 0; j < 3; j++) {
...
void free_view(_Explorer *monitor) {
    for(int i = 0; i < 3; i++) {
