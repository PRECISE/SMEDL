...
typedef enum { SIMPLEPARSERMON_GETTIME_EVENT, SIMPLEPARSERMON_GETLAT_EVENT, SIMPLEPARSERMON_GETLON_EVENT, SIMPLEPARSERMON_GETDIST_EVENT, SIMPLEPARSERMON_GETSPEED_EVENT } simpleparsermon_event;
