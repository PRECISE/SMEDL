...
if (executed_scenarios[STRINGLITERALTEST_SC1_SCENARIO]==0) {
  switch (monitor->state[STRINGLITERALTEST_SC1_SCENARIO]) {
    case STRINGLITERALTEST_SC1_START:
        raise_stringliteraltest_pong(monitor, "pong", 1,provenance);
...
void stringliteraltest_pong(StringliteraltestMonitor* monitor, char* v0, int v1, smedl_provenance_t* provenance) {
executeEvents(monitor);
}
